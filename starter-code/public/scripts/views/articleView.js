...
(function(module) {
  ...
  // COMMENT: What is this function doing? Where is it called? Does it call any other functions, and if so, in what file(s) do those function(s) live? compiles data into an object for the template. appends the article into the dom.
